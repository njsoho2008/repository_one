...
abstract class BasicDataDefaultValue {
    static byte a;
    static short b;
    static int c;
    static long d;
    ...
    //String不是基本类型
    static String str1 = "";
    // 生成一个String类型的引用，而且分配内存空间来存放"";
    static String str2;

    // 只生成一个string类型的引用；不分配内存空间,默认为null
    public static void main(String[] args) {
        ...
        System.out.println("字符的最小值:"+Character.MIN_VALUE);
        System.out.println("字符的最大值:"+Character.MAX_VALUE);
    }
}
